...
<br><br><br>
<footer>
    <div class="footer-back"  style="background-color:#bb9f8a;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-2"><br>
                    <h6>بخش های سایت</h6>
                    <hr class="header-caption-footer">
                    <a style=" display:block;margin-top: 10px;" href="">قوانین و مقررات</a>
                    <a style=" display:block;margin-top: 10px;"  href="">تبلیغات</a>
                    <a style=" display:block;margin-top: 10px;" href="">درباره ما</a>
                    <a style=" display:block;margin-top: 10px;"  href="">ارتباط با ما</a>
                </div>
                ...
                <div class="col-12 col-lg-3"><br>
                    ...
                    <div>
                        ...
                        <span style="font-size: 10px;">ایمیل : ***@gmail.com</span>
                    </div>
                    <div>
                        ...
                        <span style="font-size: 10px;">تلفن تماس : </span>
                    </div><br>
                </div>
